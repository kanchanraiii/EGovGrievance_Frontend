...
@Component({
  ...
  styles: [
    ...
    .card{background:var(--panel);border:1px solid var(--border);border-radius:14px;padding:.85rem;display:flex;flex-direction:column;gap:.6rem;box-shadow:0 10px 18px rgba(28,39,56,0.08)}
    .card-head h2{margin:0;font-size:1.02rem}
    .helper{margin:0;color:var(--muted);font-size:.9rem}
    .actions{display:flex;gap:.5rem;flex-wrap:wrap;align-items:center}
    .button{border:none;border-radius:999px;background:var(--accent);color:#fff;padding:.55rem 1.05rem;font-weight:700;cursor:pointer;box-shadow:0 8px 18px rgba(31,79,147,0.18);font-size:.9rem}
